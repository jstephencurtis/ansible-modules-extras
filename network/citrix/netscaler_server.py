...
"""
Ansible module to manage Citrix NetScaler server objects
(c) 2014, Josh Curtis <josh@joshcurtis.com>
...
version_added: "1.2"
short_description: Manages Citrix NetScaler server object creation.
description:
     - Manages Citrix NetScaler server object creation.
options:
  nsc_host:
    description:
...
author: Nandor Sivok/Josh Curtis
'''
